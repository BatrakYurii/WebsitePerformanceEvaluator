    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                if (urlsForCrawling == null)
                    throw new ArgumentNullException("Input string was empty or null");

                //Add slash to the end if it is not exist to normalize baseUrl
                urlsForCrawling = urlsForCrawling.EndsWith('/') ? urlsForCrawling : urlsForCrawling + '/';
